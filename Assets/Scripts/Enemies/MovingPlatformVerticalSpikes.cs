...
public class MovingPlatformVerticalSpikes : HarmlessMobileBase, ISavable, ILoadable<MovingPlatformVerticalSpikesData>
{
    [HideInInspector]
    ...
    private MovingPlatformVerticalSpikesData _savedData;
    ...
    public void SaveData()
    {
        if (!beingDragged)
        {
            _savedData = new MovingPlatformVerticalSpikesData();
    ...
    public void LoadData(MovingPlatformVerticalSpikesData movingPlatformData)
    {
