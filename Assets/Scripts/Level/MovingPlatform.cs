...
public class MovingPlatform : HarmlessMobileBase, ISavable, ILoadable<MovingPlatformData>
{
    [HideInInspector]
    ...
    private MovingPlatformData _savedData;
    ...
    public void SaveData()
    {
        if (!beingDragged)
        {
            _savedData = new MovingPlatformData();
    ...
    public void LoadData(MovingPlatformData movingPlatformData)
    {
